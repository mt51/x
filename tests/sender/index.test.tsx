...
describe('Sender Component', () => {
  ...
  it('action as ReactNode', () => {
    const { container } = render(
      <Sender actions={<div className="bamboo" />} />,
    );
  ...
  describe('footer', () => {
    it('footer width function', () => {
      ...
      const clearButton = container.querySelector(
        '.sender-footer-test button[disabled]',
      );
      expect(clearButton).toBeInTheDocument();
    ...
    it('footer width reactNode', () => {
      const { container } = render(
        <Sender
          footer={
            <div className="sender-footer-test-reactNode">
              footer width reactNode
            </div>
          }
        />,
      );
      expect(
        container.querySelector('.sender-footer-test-reactNode'),
      ).toBeTruthy();
    });
  });

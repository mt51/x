...
describe('attachments', () => {
  ...
  it('add and remove file', async () => {
    ...
    // Remove file
    fireEvent.click(
      container.querySelector('.ant-attachment-list-card-remove')!,
    );
    await waitFakeTimer();
  ...
  it('add and remove file but can stop remove', async () => {
    ...
    await waitFakeTimer();
    expect(
      container.querySelectorAll('.ant-attachment-list-card'),
    ).toHaveLength(1);
  ...
  it('overflow: scrollX', () => {
    ...
    expect(
      container.querySelector('.ant-attachment-list-overflow-scrollX'),
    ).toBeTruthy();
  });
  ...
  it('overflow: scrollY', () => {
    ...
    expect(
      container.querySelector('.ant-attachment-list-overflow-scrollY'),
    ).toBeTruthy();
  });
});
